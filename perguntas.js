export const perguntas = [
    {
        enunciado: "Qual o último campeão da copa o mundo?",
        alternativas: [
            {
                texto: "argentina",
                afirmacao: [
    ...
    {
        enunciado: "Quantas vezs o Brasil foi campeão da copa o mundo?",
        alternativas: [
            {
                texto: "5",
                afirmacao: [
    ...
    {
        enunciado: "Quantos gols Pelé tem em sua carreira?",
        alternativas: [
            {
                texto: "1124",
                afirmacao: [
